...
// ===== ESP32 Pin Diagram =====
//Jalur kanan: V5 GND SD3 SD2 G13 GND G12 G14 G27 G26 G25 G33 G31 G35 G34 SN SP EN 3V3 
//Jalur kiri: CLK SD0 SD1 G15 G2 G0 G1 G16 G17 G5 G18 G19 GND G21 RXD TXD G22 G33 GND
...
//| Modul   | Fungsi | GPIO   | Ambil dari |
//| ------- | ------ | ------ | ---------- |
//| MAX7219 | DIN    | GPIO13 | **Kanan**  |
//| MAX7219 | CS     | GPIO27 | **Kanan**  |
//| MAX7219 | CLK    | GPIO14 | **Kanan**  |
//| MAX7219 | VCC    | 5V     | **Kanan**  |
//| MAX7219 | GND    | GND    | **Kanan**  |
//| Buzzer  | I/O    | GPIO25 | **Kanan**  |
//| Buzzer  | VCC    | 3V3    | **Kanan**  |
...
MD_Parola display(HARDWARE_TYPE, DIN_PIN, CLK_PIN, CS_PIN, MAX_DEVICES);
